...
# dataset setting
parser.add_argument('--root-dir', type=str, default='xx', help='root path to dataset')
parser.add_argument('--data-root-dir', type=str, default='xx', help='root path to dataset')
